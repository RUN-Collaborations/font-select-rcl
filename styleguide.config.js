...
const sections = [
  ...
  {
    name: 'Codesandbox',
    description: 'The following links lead to Codesandbox examples:<br /><br /><ul><li>[Material UI Example](https://codesandbox.io/s/mui-font-detect-rhl-xui47y?file=/src/components/SelectMUI.js)<ul><li>See also [Simple USFM Editor App](https://simple-usfm-editor-app.netlify.app/) / [source code](https://github.com/klappy/simple-usfm-editor-app/blob/main/src/components/font-configuration/)</li></ul></li><li>[Tailwind CSS Example with Headless UI](https://codesandbox.io/s/font-detect-rhl-react18-tailwindcss3-headlessui-sfcneo?file=/src/components/Example.jsx)<br /><sup>(Refresh browser if 502 gateway error occurs.)</sup><ul><li>See also [Simple USFM Alignment Prototype](https://simple-usfm-alignment-prototype.netlify.app/) / [source code](https://github.com/RUN-Collaborations/simple-usfm-alignment-prototype/blob/master/src/components/FontDropdown.jsx)</li></ul></li><li>[useDetectDir Example](https://codesandbox.io/s/usedetectdir-font-detect-rhl-280fws?file=/src/components/DetectDir.jsx)<br />&nbsp;</li><li>[useAssumeGraphite Example](https://codesandbox.io/s/useassumegraphite-font-detect-rhl-dnlqs1?file=/src/components/UtilizeGraphiteFonts.jsx)</li></ul>',
  },
  {
    name: 'Web Fonts',
    description: 'Web fonts are not addressed by this rhl, though are an additional app concern for developers to consider. There are multiple ways in which web fonts can be delivered, such as base64, woff2, woff, ttf, otf, packaged with an app, self hosted, or third-party-hosted.<br /><br />If providing a web font for which a user may also have a local version, consider making allowances for the possiblity that version differences can exist. Consider giving users maximum control by allowing selection of either a web font or a locally installed version of the font, taking care not to override one with the other.<br /><br />For further insight on application of webfonts, see [How to Optimize Web Font Loading Performance with Best Practices](https://www.holisticseo.digital/pagespeed/loading-font/).<br /><br />And for one approach to webfonts coupled with locally detected fonts, see:<br><ul><li>[Font-Detect-RHL Embedded Web Fonts with MUI in Codesandbox](https://codesandbox.io/s/mui-font-detect-rhl-embedded-web-fonts-rtn566?file=/src/components/SelectMUI.js)</li><li>[Font-Detect-RHL Embedded Web Fonts with TailwindCSS and HeadlessUI in Codesandbox](https://codesandbox.io/s/font-detect-rhl-react18-tailwindcss3-headlessui-embedded-web-fonts-6m4gdt?file=/src/components/Example.jsx)<br /><sup>(Refresh browser if 502 gateway error occurs.)</sup></li></ul>',
  },
];
