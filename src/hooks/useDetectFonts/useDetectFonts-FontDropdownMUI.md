<!-- # useDetectFonts -->
This utilizes arrays of detected fonts from json files that are returned with a detected boolean attribute. Font size and line height are also shown as additional examples. Text can be typed or pasted into the text area, with RTL and LTR text autodetected. This example also utilizes MUI.
```jsx
